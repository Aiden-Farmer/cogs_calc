...
class TestInventoryRowAllocation:
    ...
    def test_allocation_from_landed_cost_appends_lc_purchase_date_to_inv_row_purchase_dates(self):
        inv_row, cost = self._create_row_instances()
    ...
    def test_allocation_from_purchase_greater_than_inventory_only_allocates_inventory(self):
        inv_row, cost = self._create_row_instances()
        cost.qty = 500
