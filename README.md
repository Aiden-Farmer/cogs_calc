...
### About
*Cost of Goods Sold (COGS) Calcululator* calculates Inventory Asset valuation and cost of goods sold, sometimes correctly!
Can use different or same data sources for Current Inventory, Purchase Records, and Sales Records.
...
- `src/adapters.py` — I/O adapters (Excel readers, TODO: Sellercloud reader, output workbook writer)
...
- `src/transfers/` — sku to sku transfer record handler
